...
parser.add_argument('--d-lr', type=float, default=0.0005, help='Learning rate for the discriminator')
parser.add_argument('--g-lr', type=float, default=0.0005, help='Learning rate for the generator')
